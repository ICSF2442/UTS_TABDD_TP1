...
class TrackingRepository:
    ...
    def publish_notification(self, line_id: str, delay_minutes: int):
        message = {
            "event": "line_delay",
            "line_id": line_id,
            "delay_minutes": delay_minutes,
